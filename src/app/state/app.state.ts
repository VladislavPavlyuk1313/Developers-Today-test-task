...
import {
  ...
  FetchNextPublicHolidays, FetchNextPublicHolidaysSuccess,
...
export class AppState implements NgxsOnInit {
  ...
  constructor(private countriesService: CountriesService, private holidayService: HolidayService) {
  }
  ...
  fetchPublicHolidays(
    ...
    this.holidayService.getPublicHolidays(year, countryCode).subscribe({
      next: holidays => dispatch(new FetchPublicHolidaysSuccess(year, countryCode, holidays)),
  ...
  fetchNextPublicHolidays(
    ...
    this.holidayService.getNextPublicHolidays(countryCode).subscribe({
      next: holidays => dispatch(new FetchNextPublicHolidaysSuccess(countryCode, holidays)),
