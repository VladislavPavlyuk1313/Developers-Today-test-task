...
export class FetchPublicHolidays {
  ...
  constructor(public year: number, public countryCode: CountryCode) { }
}

export class FetchPublicHolidaysSuccess {
  static readonly type = '[App] FetchPublicHolidaysSuccess';
  constructor(public year: number, public countryCode: CountryCode, public holidays: PublicHoliday[]) { }
}
...
export class FetchNextPublicHolidaysSuccess {
  ...
  constructor(public countryCode: CountryCode, public holidays: PublicHoliday[]) { }
}
